...
Page({
  ...
  getSeckillCommodityList: function () {
    ...
    wx.request({
      url: app.globalData.shopRequestUrl + "Seckill/getSeckillCommodityList",
      data: {
      ...
      success: function (result) {
        ...
        if (results.success == true) {
          ...
          if(_this.data.idx==1){
            _this.data.goodsList.forEach(o => { endTimeList.push(app.dateFromString(o.enddatetime)) })
          }else{
            _this.data.goodsList.forEach(o => { endTimeList.push(app.dateFromString(o.startdatetime)) })
          }
  ...
  goShopDetails:function(e){
    if(this.data.idx==2){
      ...
      wx.navigateTo({
        url: '/pages/seckillDetails/seckillDetails?shopId=' + shopId,
      })
    }
  }
})
